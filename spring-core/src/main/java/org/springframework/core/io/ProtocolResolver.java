...
/**
 *
 * 用户自定义协议资源解决策略，作为DefaultResourceLoader的SPI，它允许用户自定义资源加载协议，而不是继承DefaultResourceLoader，Spring默认是没有该接口的实现，
 * 需要用户自定义，自定义的ProtocolResovler需要使用DefaultResourceLoader的addProtocolResolver()方法加入其中 <br/>
 * 
 * A resolution strategy for protocol-specific resource handles.
 *
 * <p>
 * Used as an SPI for {@link DefaultResourceLoader}, allowing for custom protocols to be handled
