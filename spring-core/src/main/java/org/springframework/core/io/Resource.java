 ...
 *
 * <p>
 * An InputStream can be opened for every resource if it exists in physical form, but a URL or File
 * handle can just be returned for certain resources. The actual behavior is
...
public interface Resource extends InputStreamSource {
    ...
    /**
     * Determine(确定) whether this resource actually exists in physical form.
     * <p>
     * This method performs a definitive(确定) existence(存在性) check, whereas the existence of a
    ...
    /**
     * Indicate(指示) whether this resource represents a handle with an open stream. If {@code true}, the
