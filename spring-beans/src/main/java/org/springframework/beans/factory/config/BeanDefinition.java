...
public interface BeanDefinition extends AttributeAccessor, BeanMetadataElement {
     ...
     * {@link org.springframework.beans.factory.parsing.ComponentDefinition}. {@code SUPPORT} beans
     * are considered important enough to be aware of when looking more closely at a particular
     * {@link org.springframework.beans.factory.parsing.ComponentDefinition}, but not when looking
     * at the overall configuration of an application.
     */
    int ROLE_SUPPORT = 1;
     ...
     * completely part of the internal workings of a
     ...
     * <p>
     * The class name can be modified during bean factory post-processing, typically replacing the
     ...
     * <p>
     * Note that this does not have to be the actual class name used at runtime, in case of a child
     ...
     * <p>
     * If {@code false}, the bean will get instantiated on startup by bean factories that perform
     ...
     * <p>
     * Note that this flag is designed to only affect type-based autowiring. It does not affect
     ...
     * <p>
     * If this value is {@code true} for exactly one bean among multiple matching candidates, it
     ...
     * well as tools with an indication of the role and importance of a particular
     * {@code BeanDefinition}.
     * 
     * @since 5.1
     ...
     * <p>
     * Note that this method returns the immediate originator. Iterate through the originator chain
